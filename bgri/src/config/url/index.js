const HOST = "192.168.43.176";
const PORT = 9000;

module.exports.URL_CREATE_ACCOUNT =
  'http://'+HOST+':'+PORT+'/v0/create_account';
module.exports.URL_BUILD_CONTRACT =
  'http://'+HOST+':'+PORT+'/v0/build_smart_contract';
...
module.exports.URL_GET_LIST_HOUSEHOLDS =(id,contact)=>{
  return `http://${HOST}:${PORT}/v0/${id}/${contact}/get_list_households`
}
...
module.exports.URL_GET_PRODUCT=(address) =>(
  `http://${HOST}:${PORT}/v0/${address}/get_product`
)
module.exports.URL_GET_QR_CODE=(address) =>(
  `http://${HOST}:${PORT}/v0/${address}/get_qr_code`
)
module.exports.URL_SET_QR='http://' + HOST + ':' + PORT + '/v0/set_qr_code'
module.exports.URL_SET_HISTORY='http://' + HOST + ':' + PORT + '/v0/set_history'
module.exports.URL_GET_ACTIONS=(address,key)=>('http://' + HOST+ ':' + PORT + '/v0/'+address+'/'+key+'/get_one_qr_code')
module.exports.URL_GET_HISTORY=(address)=>('http://' + HOST + ':' + PORT + '/v0/'+ address+'/get_history')
...
module.exports.URL_GET_LIST_FARMER_MESS= (address) =>('http://' + HOST + ':' + PORT + '/v0/'+address + '/get_msg_action_for_farmer')
