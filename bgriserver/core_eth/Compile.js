...
function getImports(dependency) {
    ...
    switch (dependency) {
        case 'Migrations.sol':
            return {contents: fs.readFileSync(path.resolve(__dirname, 'contracts', 'Migrations.sol'), 'utf8')};
...
async function writeOutput(data) {
    ...
    for (let contractFileName in compiled.contracts) {
        ...
        bytecodeobject = compiled.contracts[contractFileName][contractName].evm.bytecode.object
        fs.outputJsonSync(
